    ...
    for (const key in message) {
      ...
      if (
        ...
        if (key === "textBody" && value[0]) {
          ...
          if (key === "header:X-Priority:asText")
            cleanedMessage["X-Priority"] = value;
          else if (key === "header:Importance:asText")
            cleanedMessage["Importance"] = value;
          else if (key === "header:Priority:asText")
            cleanedMessage["Priority"] = value;
          else if (key === "header:Auto-Submitted:asText")
            cleanedMessage["Auto-Submitted"] = value;
        } else {
