...
export class TokenManager {
  ...
  constructor(options = {}) {
    ...
    this.deviceEndpoint =
      options.deviceEndpoint || process.env.JMAP_AUTH_DEVICE_ENDPOINT || "";
    this.clientId =
      options.clientId || process.env.JMAP_CLIENT_ID || DEFAULT_CLIENT_ID;
  ...
  async deviceLogin(options = {}) {
    ...
    if (options.onInstruction) {
      options.onInstruction({ userCode, verificationUri: uri });
    } else {
      console.log("");
      console.log("╔══════════════════════════════════════════════════╗");
